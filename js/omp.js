$(document).ready(function() {
        $('.OMP').each(function() {
            ...
            if(!video_theme) video_theme="3";
            $('head').append("<link href=css/skin-omp" + video_theme + ".css rel='stylesheet' type='text/css'>")
            //main wrapper
            ...
            var getDuration = function() {
                if(video.attr('readyState')) {
                   return video.attr('duration');
                } else {
                    setTimeout(getDuration, 20);
                }
            };

            var traceDuration = function() {
                return gTimeFormat(getDuration());
            };

            var insertVideoDuration = function() {
                video_timer.after('<div class="video-duration"> &nbsp| ' + traceDuration() + '</div>');
            };
            ...
            var defineVolumeSensePosition = function() {
                return (video_theme == "3") ? "horizontal" : "vertical";
           };
            ...
            if(video_theme == "3") setTimeout(insertVideoDuration, 300);
});
});
